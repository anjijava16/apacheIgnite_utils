...
public class CacheLoadOnlyStoreExample {
	...
	/** Cache name. */
    private static final String CACHE_NAME = ConstantsUtils.CACHE_NAME;
    ...
    public static void main(String[] args) throws IgniteException {
        try {
			...
			ProductLoader productLoader = new ProductLoader(ConstantsUtils.INPUT_LOAD_CSV);
			...
			IgniteCache<Long, Person> cache = ignite.getOrCreateCache(cacheConfiguration(productLoader));
    ...
    private static class ProductLoader extends CacheLoadOnlyStoreAdapter<Long, Person, String> implements Serializable {
        ...
        @Override protected Iterator<String> inputIterator(@Nullable Object... args) throws CacheLoaderException {
            ...
            try {
                File path = IgniteUtils.resolveIgnitePath(ConstantsUtils.INPUT_LOAD_CSV);
